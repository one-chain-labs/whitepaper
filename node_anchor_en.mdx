...
- **Entry Conditions**: A certain amount of USDT needs to be staked.
...
- **Assessment Criteria:**:
  ...
  - Capital Contribution: 5 million USDT introduced/month
...
- **Node Incentives**:
  ...
  - **Periodic Rewards**: Extra OCT/USDT rewards based on staking ratio and contribution to ecosystem growth.
...
- **Evaluation Criteria**:
  ...
  - Capital Contribution: 1 million USDT introduced/month
...
- **Node Incentives**:
  - **Periodic Rewards**: Nodes will receive additional ecological rewards (mainly OCT and USDT) based on their application contributions, further incentivising application developers to actively participate in ecosystem co-creation.
...
- **Evaluation Criteria**:
  ...
  - Total amount of OCT/USDT introduced: 1,000,000 new USDO
  - Trading frequency: more than 1,000 transactions per day
  - **Node Incentives**: Nodes will receive additional ecological rewards (mainly OCT and USDT) based on their asset contributions, further incentivising asset holders to actively participate in ecological co-creation
...
- In order to incentivise nodes for their active contribution to the ecosystem, Onechain will additionally replenish a certain percentage of the USDT reward pool, and distribute the rewards through the actual contribution of the C[i] nodes based on the comprehensive calculation value.
...
- **Contribution Reward Formula**:
  ...
  - T_USDT: USDT reward pool for the current period
